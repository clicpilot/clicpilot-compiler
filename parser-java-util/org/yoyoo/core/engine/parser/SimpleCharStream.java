...
public class SimpleCharStream implements CharStream {
	...
	protected void ExpandBuff(boolean wrapAround) {
		...
		try {
			if (wrapAround) {
				...
				System.arraycopy(bufoffset, tokenBegin, newbufoffset, 0,
						bufsize - tokenBegin);
				System.arraycopy(bufoffset, 0, newbufoffset, bufsize
						- tokenBegin, bufpos);
	...
	public int getEndColumn() {
		lastTokenEnd2 = lastTokenEnd1;
		lastTokenEnd1 = bufoffset[bufpos];
		return bufcolumn[bufpos];
	}
	...
	public int getBeginColumn() {
		lastTokenBegin2 = lastTokenBegin1;
		lastTokenBegin1 = bufoffset[tokenBegin];		
	...
	private int lastTokenBegin1 = -1;	
	private int lastTokenEnd1 = -1;
	private int lastTokenBegin2 = -1;	
	private int lastTokenEnd2 = -1;
	...
	public int getEndOffset() {
		...
		return bufoffset[bufpos];
	}
	
	public int getLastTokenBeginOffset(){
		return lastTokenBegin2;
	}
	
	public int getLastTokenEndOffset(){
		return lastTokenEnd2;
	}
